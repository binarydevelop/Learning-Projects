...
router.put('/api/approve/feedback/:id/:signature/:code', verifyToken, controller.approveFeed);//Approve a Feedback
...
router.delete('/api/delete/entity/:id/:code', verifyToken, controller.deleteEntity); // delete Entity by id [only Admin]
router.delete('/api/delete/feedback/:id/:signature/:code', verifyToken, controller.deleteFeedback);
